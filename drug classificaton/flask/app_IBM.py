...
def predict():
    ...
    response_scoring = requests.post(
        'https://us-south.ml.cloud.ibm.com/ml/v4/deployments/4f7acb7a-f964-4779-a8a6-25a6831a5988/predictions?version=2022-08-07',
        json=payload_scoring,
        headers={'Authorization': 'Bearer ' + mltoken})
    print("Scoring response")
    prediction=response_scoring.json()
    print(prediction)
    output=prediction["predictons"][0]["values"][0][0]
    if(output==0):
